...
public abstract class ExtendedLavaFluid extends LavaFluid
{
	...
	public ExtendedLavaFluid(Function<Fluid, Fluid> still, Function<Fluid, Fluid> flowing, Function<Fluid, BlockState> blockState, Function<Fluid, Item> bucket)
	{
		stillSupplier = still;
	...
	public static class Flowing extends ExtendedLavaFluid
	{
	...
	public static class Still extends ExtendedLavaFluid
	{
